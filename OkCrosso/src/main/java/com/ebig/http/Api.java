...
public class Api extends ApiHelper implements IApi {
     ...
     *
     * @param params
     * @return 对应db:base_goods_strategy
     */
    @Override
