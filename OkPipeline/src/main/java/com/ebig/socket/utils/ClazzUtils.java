...
public class ClazzUtils {
    ...
    public static <T> List<T> getClassSet(String packName, Class<T> object) {
        Reflections reflection = new Reflections(packName);
        //  Map<String,Class> map=new HashMap<>();
        Set<Class<? extends T>> set = reflection.getSubTypesOf(object);
    ...
    public static Class<?> getInstance(String interclass) {
        try {
            return Class.forName(interclass);
